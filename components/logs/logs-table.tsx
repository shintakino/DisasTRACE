...
const ActionBadge = ({ action }: { action: LogAction }) => {
  const styles: Record<LogAction, string> = {
    ...
    ARRIVED: "bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-900/30 dark:text-amber-300 dark:border-amber-850",
    STARTED: "bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-850",
...
const StatusBadge = ({ status }: { status: LogStatus }) => {
  const styles: Record<LogStatus, string> = {
    ...
    "ON-SCENE": "bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-900/30 dark:text-amber-300 dark:border-amber-800",
